        ...
        <div className={styles.Total}>
          ...
          <nav className="navbar navbar-expand-lg justify-content-between navb">
            <Link to="/">
              ...
              {/* O Link que precisar importar, para a pagina anterior */}
            </Link>
            <div className="Area">
              {/* O campo de busca */}
              <form className="form-inline">
                ...
                <button
                  ...
                  onClick={($event) => this.Atualiza($event)}
                >
                  Buscar
                </button>
              </form>
          ...
          <div>
            {results.map((item) => {
              // Mapiando os itens do array results
              return (
                <div className={styles.Resultados} key={item.url}>
                  {/* item, como paramentro, e o valor desejando dentro do array */}
                  <Link
                    to={`/person/${
